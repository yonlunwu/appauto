...
FT_PREFIX = "CUDA_VISIBLE_DEVICES=1,2 PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True /root/miniforge3/envs/ftransformers/bin/python -m ftransformers.launch_server --host 0.0.0.0 --port {}"
